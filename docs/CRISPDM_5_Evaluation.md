...
Como se aprecia en la tabla, los números cuadran a la perfección. La tasa de conversión es coherente (rondando el X%) y no hay valores negativos ni duplicados raros.
