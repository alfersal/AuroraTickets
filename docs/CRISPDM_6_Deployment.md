...
![Arquitectura AWS](../evidence/image16.png)
...
He desplegado 6 instancias usando Ubuntu. Tengo una máquina dedicada solo para la web y su agente, un Spark Master que orquesta todo, 3 Spark Workers que se comen el trabajo pesado, y un Nodo Submit desde donde lanzo yo las órdenes. Están en la misma red y configurados por SSH.

![Panel EC2](../evidence/image8.png)
...
![Spark UI 1](../evidence/image9.png)
![Spark UI 2](../evidence/image10.png)

## Reproducibilidad End-to-End
El tribunal pide que este proyecto sea reproducible, es decir, que si otra persona entra a mi clúster, sepa cómo arrancar todo. La ventaja de haber montado un clúster Standalone de Spark es que el lanzamiento de tareas está totalmente centralizado en el Nodo Submit.
...
![Carpetas S3 Salida](../evidence/image13.png)
